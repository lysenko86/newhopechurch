...
export const DoctrinePage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-24 text-black-100">
      ...
      <p className="mt-4">{dataDoctrinePage[lang].content[2]}</p>
      <p className="mt-4">{dataDoctrinePage[lang].content[3]}</p>
      <h2 className="mt-14 text-450 md:text-500 font-bold">
        {dataDoctrinePage[lang].content[4]}
      </h2>
      <p className="mt-4">{dataDoctrinePage[lang].content[5]}</p>
      <ul className="mt-4">
        ...
        <li className="mt-2">{dataDoctrinePage[lang].content[12]}</li>
        <li className="mt-2">{dataDoctrinePage[lang].content[13]}</li>
        <li className="mt-2">{dataDoctrinePage[lang].content[14]}</li>
        <li className="mt-2">{dataDoctrinePage[lang].content[15]}</li>
      </ul>
    </div>
  );
};
